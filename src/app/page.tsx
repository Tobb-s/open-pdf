...
export default function Home() {
  ...
  const filtered = useMemo(() => {
    ...
    return TOOLS.filter((tool) =>
      `${tool.title} ${tool.tagline} ${tool.keywords.join(' ')}`.toLowerCase().includes(needle)
    );
  }, [query]);
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto max-w-5xl px-6 sm:px-8">
        <section className="pb-16 pt-24 text-center">
          ...
          <h1 className="mb-5 text-5xl font-medium leading-tight tracking-tight text-gray-900 sm:text-6xl text-balance">
            PDF tools,
            <br />
          ...
          <p className="mx-auto mb-10 max-w-xl text-lg leading-relaxed text-gray-500">
            Your files never leave your device. There is no upload, and no server to upload to —
            every tool here runs in the page you are reading.
          </p>

          <div className="relative mx-auto max-w-lg">
            <div className="flex items-center rounded-full border border-gray-200 bg-white py-2 pl-5 pr-2 shadow-sm transition-all hover:border-gray-300 focus-within:border-blue-400 focus-within:shadow-md">
        ...
        <section className="pb-24">
          <div className="rounded-3xl border border-gray-100 bg-gray-50 p-10 text-center sm:p-14">
            ...
            <h2 className="mb-3 text-2xl font-medium text-gray-900">Why OpenPDF?</h2>
            <p className="mx-auto max-w-2xl text-sm leading-relaxed text-gray-500">
              Most online PDF tools ask you to upload your document to someone else&apos;s server.
              OpenPDF has no server to upload to: the whole application is static files, and the
              PDF engine runs in your browser. Nothing you open here is transmitted anywhere.
            </p>
          </div>
        </section>
      </main>

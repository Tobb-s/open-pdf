    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto max-w-4xl px-4 py-12">
        <div className="mb-12 text-center">
          <h1 className="mb-4 text-4xl font-bold text-gray-900">Fill a PDF form</h1>
          <p className="text-gray-600">
            Complete the interactive fields of a PDF form, right here on your device.
          </p>
        </div>
          ...
          <div className="space-y-6">
            ...
            >
              <div className="flex flex-col items-center gap-4">
                ...
                <p className="text-lg font-semibold">Choose a PDF form</p>
                <p className="text-sm text-gray-500">A PDF with fillable fields</p>
              </div>
            </FileDropzone>
          ...
          <div className="space-y-6">
            ...
            {isLoading ? (
              <div className="flex items-center justify-center p-12">
                ...
                <span className="ml-3 text-gray-600">Looking for form fields…</span>
              </div>
            ) : fields.length === 0 ? (
              <div className="rounded-3xl border bg-white p-12 text-center">
                <p className="text-gray-700">This PDF has no interactive form fields.</p>
                <p className="mt-2 text-sm text-gray-500">
                  Forms designed to be printed and written on by hand have no fields to fill. Use
                  Edit PDF to place text on the page instead.
                </p>
              </div>
            ) : (
              <div className="space-y-4">
                <div className="rounded-3xl border bg-white p-6 shadow-sm">
                  <h2 className="mb-6 font-semibold text-gray-700">Form fields</h2>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 p-4">
            <div className="max-w-md rounded-3xl border bg-white p-10 text-center shadow-xl">
              ...
              <h2 className="mb-2 text-2xl font-bold">
                Filled {result.filled} of {fields.length}{' '}
              ...
              {result.skipped.length > 0 ? (
                <div className="mb-6 mt-4 flex items-start gap-3 rounded-2xl border border-amber-200 bg-amber-50 p-4 text-left">
                  ...
                  <p className="text-sm text-amber-900">
                    These fields could not be written and were left as they were:{' '}
                    <span className="font-semibold">{result.skipped.join(', ')}</span>. They may be
                    read-only, or contain characters the form&apos;s font cannot show.
                  </p>
                </div>
              ) : (
                <p className="mb-8 text-gray-600">Your completed form is ready.</p>
              )}

...
export const es: Dictionary = {
  ...
  studio: {
    ...
    toolHint: {
      ...
      erase: 'Arrastrá encima de lo que querés borrar. La zona se borra en blanco y la página se rehace como imagen, perdiendo su texto seleccionable. No elimina coincidencias en otras zonas ni datos ocultos: para información sensible usá Tachar.',
...
export const en: Dictionary = {
  ...
  studio: {
    ...
    toolHint: {
      ...
      erase: 'Drag over what you want erased. The area is erased to white and the page is rebuilt as an image, losing its selectable text. Matching text elsewhere and hidden data are not removed: use Redact for sensitive information.',
